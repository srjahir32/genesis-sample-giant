...
return array(
	'dependencies'     => array(
		'plugins' => array(
			...
			array(
				'name'       => __( 'Genesis Super Customizer', 'genesis-sample' ),
				'slug'       => 'genesis-super-customizer/genesis-super-customizer.php',
				'public_url' => 'https://wordpress.org/plugins/genesis-super-customizer/',
			),
			array(
